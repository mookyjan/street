...
@objc class ConstantDevices :NSObject {
    ...
    static let SCREEN_WIDTH = (((UIApplication.sharedApplication().statusBarOrientation == UIInterfaceOrientation.Portrait) || (UIApplication.sharedApplication().statusBarOrientation == UIInterfaceOrientation.PortraitUpsideDown)) ? UIScreen.mainScreen().bounds.size.width : UIScreen.mainScreen().bounds.size.height)
    static let SCREEN_HEIGHT = (((UIApplication.sharedApplication().statusBarOrientation == UIInterfaceOrientation.Portrait) || (UIApplication.sharedApplication().statusBarOrientation == UIInterfaceOrientation.PortraitUpsideDown)) ? UIScreen.mainScreen().bounds.size.height : UIScreen.mainScreen().bounds.size.width)
    ...
    static let IS_IPAD = UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Pad
    static let IS_IPHONE = UIDevice.currentDevice().userInterfaceIdiom == UIUserInterfaceIdiom.Phone
    ...
    static let IS_IPHONE_5_IOS7 = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height == 568.0)
    static let IS_IPHONE_6_IOS7 = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height == 667.0)
    static let IS_IPHONE_6P_IOS7 = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height == 736.0)
    static let IS_IPHONE_4_AND_OLDER_IOS7 = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height < 568.0)
    static let IS_IPHONE_4_OR_5 = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height <= 568.0)
    static let IS_IPHONE_4_OR_5_OR_6 = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height <= 667.0)
    static let IS_IPHONE_4_OR_5_OR_6_OR_6P = (IS_IPHONE && UIScreen.mainScreen().bounds.size.height <= 736.0)
    ...
    static let IS_IOS6_AND_UP = (CFloat(UIDevice.currentDevice().systemVersion)! >= 6.0)
    static let IS_IOS7_AND_UP = (CFloat(UIDevice.currentDevice().systemVersion)! >= 7.0)
    static let IS_IOS8_AND_UP = (CFloat(UIDevice.currentDevice().systemVersion)! >= 8.0)
    static let IS_IOS9_AND_UP = (CFloat(UIDevice.currentDevice().systemVersion)! >= 9.0)
