...
@objc class UIConfiguration :NSObject {
    static let debugClearBackground = UIColor.clearColor()
    static let debugClearBackground2 = UIColor.clearColor()
    ...
    static let IPHONE5_FRAME = CGRectMake(0, 0, 320, 568)
    static let IPHONE4_FRAME = CGRectMake(0, 0, 320, 480)

    static let kCollectionViewBackground = UIColor(red: 0.92, green: 0.92, blue: 0.92, alpha: 1)
    //for viewBack 		0
    static let MainNavBackColor = UIColor(red: 0.42, green: 0.74, blue: 0.99, alpha: 1)
    ...
    static let MainNavBackNewsListColor = UIColor.whiteColor()//[UIColor colorWithRed:233./255. green:233./255. blue:233./255. alpha:1.]
    ...
    // White Color
    static let ColorWhite = UIColor.whiteColor()
    // Black Color
    static let ColorBlack = UIColor.blackColor()
    // Purple Color
    ...
    // Green Color
    static let ColorGreen = UIColor.greenColor()
    // Clear Color
    static let ColorClear = UIColor.clearColor()
    // Light Gray Color
    static let ColorLightGray = UIColor.lightGrayColor()
    ...
    static let UIFONTAPPBOLD:String = "HelveticaNeue-Medium"
    ...
    static let fontBold10 = UIConfiguration.getUIFONTBOLD(10)
    static let fontBold12 = UIConfiguration.getUIFONTBOLD(12)
    static let fontBold13 = UIConfiguration.getUIFONTBOLD(13)
    static let fontBold14 = UIConfiguration.getUIFONTBOLD(14)
    static let fontBold15 = UIConfiguration.getUIFONTBOLD(15)
    static let fontBold16 = UIConfiguration.getUIFONTBOLD(16)
    static let fontBold18 = UIConfiguration.getUIFONTBOLD(18)
    static let fontBold20 = UIConfiguration.getUIFONTBOLD(20)
    static let fontBold21 = UIConfiguration.getUIFONTBOLD(21)
    static let fontBold22 = UIConfiguration.getUIFONTBOLD(22)
    static let fontBold24 = UIConfiguration.getUIFONTBOLD(24)
    ...
    static let kCollectionCellTitleFont = UIFont.systemFontOfSize((ConstantDevices.isIS_IPAD()) ? 15 : 13)
    static let kCollectionCellDescriptionFont = UIFont.systemFontOfSize((ConstantDevices.isIS_IPAD()) ? 15 : 13)
    static let kCollectionCellLevelCouponFont = UIFont.systemFontOfSize((ConstantDevices.isIS_IPAD()) ? 15 : ConstantDevices.IS_IPHONE_5 ? 8 : 9)
    static let kCollectionCellGameTypeFont = UIFont.systemFontOfSize((ConstantDevices.isIS_IPAD()) ? 15 : 13)//IS_IPHONE_5 ? UIFONTSYSTEM_REGULAR(12) : UIFONTSYSTEM_REGULAR(13)
